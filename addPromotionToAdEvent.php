...
if(isset($_POST['submit'])) {
    ...
    $eventcode = mysqli_real_escape_string($conn, $_POST['event']);
    ...
    //Will not allow query to be processed
    $check3 = mysqli_query($conn, "SELECT * from adeventpromotion WHERE PromoCode='$promoCode' AND EventCode='$eventCode'");
