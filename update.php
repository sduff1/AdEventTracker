...
if(isset($_POST['submit'])) {
    //Get form data
    $item_number = mysqli_real_escape_string($conn, $_POST['number']);
    ...
    $query = "UPDATE item SET item_description='$description',category = '$category', department_name = '$department', purchase_cost = '$cost', full_retail_price='$retail_cost' WHERE item_number = {$item_number}";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">Update Item</a>
            </li>
        </ul>
    </div>
</nav>
