...
if(isset($_POST['submit'])){
    ...
    //Create session variable to be used in adEventViewerTable.php
    ...
    function promoitems($pcode)
    {
        $promocode = $pcode;
        require('configuration/database.php');
        $evstr = strval($_SESSION['event_code']);
        $query2 = mysqli_query($conn, "SELECT * FROM promotionitem WHERE PromoCode = '$promocode'");
        $i=0;
        $result[] = array();
