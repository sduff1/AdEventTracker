...
if (isset($_POST['submit'])) {
    ...
    if ($checkRows > 0) {
        ...
        $query = "INSERT INTO adevent(event_code, name, start_date, end_date, description) VALUES('$AdEvent_eventCode', '$AdEvent_name','$AdEvent_startDate','$AdEvent_endDate', '$AdEvent_description')";
